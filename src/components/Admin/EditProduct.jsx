...
export default function EditProduct() {
  ...
  const fetchProductAndCategories = async () => {
    const productResponse = await axios.get(`https://fond-harlene-yassinedorgaa-7ff07ac1.koyeb.app/api/dashboard/products/${id}`);
    const categoriesResponse = await axios.get("https://fond-harlene-yassinedorgaa-7ff07ac1.koyeb.app/api/categories");
  ...
  const handleSubmit = async (e) => {
    ...
    await axios.put(`https://fond-harlene-yassinedorgaa-7ff07ac1.koyeb.app/api/dashboard/products/${id}`, updatedProduct);
    navigate("/dashboard");
  };
