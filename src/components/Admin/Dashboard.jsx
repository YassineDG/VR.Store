...
export default function Dashboard() {
  ...
  async function getProducts() {
    await axios.get("https://backend-vr-store-959276e1a5d9.herokuapp.com/api/products").then((response) => {
      setProducts(response.data);
    });
  }

  async function deleteProduct(id) {
    await axios.delete(`https://backend-vr-store-959276e1a5d9.herokuapp.com/api/dashboard/products/${id}`);
